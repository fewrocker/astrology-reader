...
- `src/data/numerologyInterpretations.ts` or a new `dreamInterpretations.ts` — optional short interpretations for Neptune placements by house/sign (can be inline strings or a small lookup map)

**Files to create (optional):**
- Short Neptune-in-house interpretation strings (can be hardcoded inline if small enough)
