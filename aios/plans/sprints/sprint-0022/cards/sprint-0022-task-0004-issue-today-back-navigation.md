...
**Status:** completed
**Commit:** c4829dd — fix(sprint-0022): today back navigation — showCachedLanding gates on chartData presence
**Branch:** sprint-0022-task-0004-issue-today-back-navigation

Applied the one-expression change to `showCachedLanding` in `/tmp/sprint-0022-task-0004-issue-today-back-navigation/src/App.tsx` line 534: added `|| !!state.chartData` alongside `state.formCompleted` in the guard condition. Build passed cleanly (tsc + vite). No other files required modification.
