...
Key files to modify:
- `src/components/reading/DailySnapshotCard.tsx` — add `birthDate?: string` prop, import `calculateNumerology` or `calculatePersonalDay`, render one new line with personal day number + archetype label
