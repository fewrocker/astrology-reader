...
export const GPT_TIMEOUT = "The reading took too long — try again."
export const GPT_NUDGE = '✦ Create an account for 20 daily readings.'

const GPT_ERROR_STRINGS = new Set([GPT_RATE_LIMIT, GPT_RATE_LIMIT_UNAUTH, GPT_SERVER_ERROR, GPT_OFFLINE, GPT_TIMEOUT])
...
export function getGptErrorMessage(text: string): string {
  ...
  if (text === GPT_TIMEOUT) {
    return 'The reading took too long. Tap to try again.'
  }
