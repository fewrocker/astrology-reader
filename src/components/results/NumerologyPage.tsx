...
import { generateNumerologyNarrative, getStoredApiKey } from '../../services/gptInterpretation'
          ...
          return (
            <div className="mb-10">
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="font-heading text-mystic-gold/50 text-xs tracking-widest">✦ Your Reading</span>
                <div className="h-px flex-1 bg-mystic-border" />
              </div>
